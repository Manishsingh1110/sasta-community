...
function Secsignin(){
  var history =useNavigate();
	const [signindetail, setsignindetail] = useState({ username :"",email: "", password: ""})
	  const handleclick = (e) => {
		  e.preventDefault();
		  signin(signindetail.username,signindetail.email, signindetail.password)
	  }
	const onchange = (e) => {
                  ...
                  <div className="card-body p-4 p-lg-5 text-black">
                    ...
                    <form>
                      ...
                      <div className="form-outline mb-4">
                        <input type="text" id="form2Example7" name='username' onChange={onchange} className="form-control form-control-lg" />
                        <label className="form-label" for="form2Example7">Username</label>
                      </div>
                      ...
                      <div className="pt-1 mb-4">
                        <button className="btn btn-dark btn-lg btn-block" onClick={handleclick} type="button">Login</button>
                      </div>
